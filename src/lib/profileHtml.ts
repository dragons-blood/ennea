...
<body><div class="wrap">
  ...
  <div class="hero">
    ...
    <div class="badge" style="border:1px solid ${c}66;color:${c}">${esc(result.clarity)} fit</div>
  </div>
  ...
  <footer>
    ...
    and your growth / stress lines are read from those scores. The Enneagram is a tool for self-understanding, not a box —
